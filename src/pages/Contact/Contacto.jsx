        ...
        return (
            <Container className="contacto-container my-5">
                <Row className="justify-content-md-center">
                    <Col md={8} lg={6}>
                        <Card
                            className="text-center p-4 shadow-sm transparent-dark-card"
                            text="light">
                            <Card.Body>
        ...
        <Container className="contacto-container my-5">
            <Row className="justify-content-md-center">
                <Col md={8} lg={6}>
                    <Card
                        text="light"
                        className="p-4 shadow-sm contact-form-dark transparent-dark-card">
                        <Card.Body>
                            <h2 className="text-center mb-4">¡Conectanos!</h2>
                            <Form onSubmit={handleSubmit}>
                                {user && (
                                    <input type="hidden" name="usuario_logueado" value={user} />
                                )}
