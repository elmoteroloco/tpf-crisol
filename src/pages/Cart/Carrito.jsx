...
export default function Carrito() {
    ...
    const { productosCarrito, vaciarCarrito, borrarProductoCarrito, actualizarCantidad } =
            ...
            {productosCarrito.length > 0 ? (
                <>
                    ...
                    <div className="text-end mt-4">
                        <span className="fs-4 fw-bold carrito-total me-3">
                ...
                <p className="text-center mt-5 fs-5 carrito-vacio-mensaje">
